...
void gen();       // I'm just adding these here for the sake of updating parser.cpp without errors ~Stephen
...
int main()
{
  ...
  while (cin >> wordPair.word)      // if word -> assign it
  {
    cin >> wordPair.translation;    // assign translation
